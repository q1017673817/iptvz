...
if [ $# -eq 0 ]; then
  ...
  echo "2. 山东电信（Shandong_279）"
  echo "3. 江西电信（Jiangxi_105）"
  echo "4. 贵州电信（Guizhou_153）"
  echo "5. 陕西电信（Shaanxi_123）"
  echo "0. 全部"
...
#        url_fofa="https://fofa.info/result?qbase64="$url_fofa
    ...
    2)
        ...
        channel_key="山东电信"
        url_fofa="https://fofa.info/result?qbase64=InVkcHh5IiAmJiByZWdpb249IuWxseS4nCIgJiYgb3JnPSJDaGluYW5ldCIgJiYgcHJvdG9jb2w9Imh0dHAi&page=1&page_size=20"
...
#        url_fofa="https://fofa.info/result?qbase64="$url_fofa
    ...
    3)
        ...
        channel_key="江西电信"
        url_fofa="https://fofa.info/result?qbase64=InVkcHh5IiAmJiByZWdpb249Iuaxn%2BilvyIgJiYgb3JnPSJDaGluYW5ldCIgJiYgcHJvdG9jb2w9Imh0dHAi&page=1&page_size=20"
...
#        url_fofa="https://fofa.info/result?qbase64="$url_fofa
    ...
    4)
        ...
        channel_key="贵州电信"
        url_fofa="https://fofa.info/result?qbase64=InVkcHh5IiAmJiByZWdpb249Iui0teW3niIgJiYgb3JnPSJDaGluYW5ldCIgJiYgcHJvdG9jb2w9Imh0dHAi&page=1&page_size=20"
#        url_fofa=$(echo  '"udpxy" && region="Guizhou" && org="Chinanet" && protocol="http"' | base64 |tr -d '\n')
#        url_fofa="https://fofa.info/result?qbase64="$url_fofa
        ;;
    5)
        city="Shaanxi_123"
        ...
        channel_key="陕西电信"
        url_fofa="https://fofa.info/result?qbase64=InVkcHh5IiAmJiByZWdpb249IumZleilvyIgJiYgb3JnPSJDaGluYW5ldCIgJiYgcHJvdG9jb2w9Imh0dHAi&page=1&page_size=20"
...
echo "湖南电信,#genre#" >zubo_fofa4.txt
cat txt/fofa_Hunan_282.txt >>zubo_fofa4.txt
echo "山东电信,#genre#" >>zubo_fofa4.txt
cat txt/fofa_Shandong_279.txt >>zubo_fofa4.txt
echo "江西电信,#genre#" >>zubo_fofa4.txt
cat txt/fofa_Jiangxi_105.txt >>zubo_fofa4.txt
echo "贵州电信,#genre#" >>zubo_fofa4.txt
cat txt/fofa_Guizhou_153.txt >>zubo_fofa4.txt
echo "陕西电信,#genre#" >>zubo_fofa4.txt
cat txt/fofa_Shaanxi_123.txt >>zubo_fofa4.txt

echo $(TZ=UTC-8 date +%Y-%m-%d" "%H:%M:%S) >zubo_fofa.txt
cat zubo_fofa1.txt zubo_fofa2.txt zubo_fofa3.txt zubo_fofa4.txt >>zubo_fofa.txt
